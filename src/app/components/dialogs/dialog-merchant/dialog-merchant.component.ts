...
export class DialogMerchantComponent {
  ...
  public insert(): void {
    this.database.insert({
      'merchants': [{
        ein: this.databaseForm.controls.ein.value,
        name: this.databaseForm.controls.name.value,
        industry: this.databaseForm.controls.industry.value,
        legal_entity: this.databaseForm.controls.legal_entity.value,
        start_date: this.databaseForm.controls.start_date.value,
