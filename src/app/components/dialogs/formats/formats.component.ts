...
export class FormatsComponent {
  ...
  constructor(private database: DatabaseService, private parserService: ParserService) {}
  ...
  public insertMerchant(): void {
    this.database.insertMerchant({
      ...
      'ownerships': [{
        merchant_id: this.merchantForm.controls.ein.value,
        owner_id: this.ownerForm.controls.ssn.value,
